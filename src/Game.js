...
class Game {
  ...
  setupRooms () {
    ...
    var livingRoom = new Room('Living room', 'A dusty and old yet lavish livig space seemingly untouched for decades sets before you. There is furniture dotted about, a couch a {ITEM:PAINTING} above the fireplace, as well as a small {ITEM:CHEST} beside the fireplace. There also a door on the {DIRECTION:NORTH} wall which you can feel a draft coming from');
    ...
    var cell1 = new Room('First cell on the left', 'You approach the first cell on the {DIRECTION:WEST} side of the tunnnel you carefully reach your hand out to the cold iron door of the small room and push it open stepping inside you find yourself is a room of some form of alcehmy you coudl asusme so many unsepakable and unkown things all in glass jars from collected plants to the organs of animals. You can only asusme what horrible things must go on down here and the errie lighting your lantern gives it does not help. Should you consider the idea of leaving the exit is still on the {DIRECTION:EAST} wall behind you. ');
    ...
    var cell3 = new Room(' Cell on the right', 'As you approach the cell you notice something in the shadows of the right hand corner,something moving and as such you take ease opening the metal cage door, the cell floor is damp and inside and you take a cautious step, at the sound of your foot padding the floor the small, pallor, and hunched {ENEMY:CREATURE} snaps around, a certain manical glint in its eyes as it stares back at you...')
    var altarChamber = new Room('Altar chamber', 'You approach the massive iron doors at the {DIRECTION:NORTH) end of the hall. You put the key into the lock forcing a twist the dust in locks causing a grind as the decades now unopened chamber is finally unsealed. You pull the door open taking a step inside, your eyes take in the sights, the room is seeming a place out of time as everything seems as new as the day is was likely brought there. A large altar lays in the middle of the room, around it is a group of skeletal remains as garbed in the same crimson robes. Another skeleton lays upon the altar top and as you approach it the shadows behind the altar seem to grow seemingly into the physical form. In moments a towering grotesque figure is before you, red skin horns and more greet you. This is it, the spirit that has come over this manor, before you can consider running back through the exit the door on the {DIRECTION:SOUTH}) side  of the room slams shut the anicent locking grinding into its sealed position. You are trapped inside, there is only one chance now to escape, you must slay the demon!');
  ...
  // Living room inventory
    ...
    livingRoom.addItem(new Item('CHEST', 'A faded old chest with a leather closing strap.', 5, 15, 7));
    // Basement inventory
